...
export const equal = (param : { value : unknown }) : object => {
...
export const notEqual = (param : { value : unknown }) : object => {
...
export const greaterThan = (param : { value : unknown }) : object => {
...
export const greaterOrEqualTo = (param : { value : unknown }) : object => {
...
export const lesserThan = (param : { value : unknown }) : object => {
...
export const lesserOrEqualTo = (param : { value : unknown }) : object => {
...
export const isOneOf = (param : { values : unknown[] }) : object => {
...
export const isNoneOf = (param : { values : unknown[] }) : object => {
...
export const exists = (param : { exists : boolean }) : object => {
...
export const matchesRegex = (param : {
  regex : string,
  options : {
    caseSensitive : boolean, multiline : boolean, dotMatchesMultiline : boolean
  }}) : object => {
